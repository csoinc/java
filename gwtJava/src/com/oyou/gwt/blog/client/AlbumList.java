...
public class AlbumList extends Composite implements TableListener, ChangeListener, ClickListener {
	...
	private HTML hSelection = new HTML("Blogger<br> 2010<br>相册Album选择Selection", true);
	private HTML hLoading = new HTML("Blogger<br> 2010<br><font color=ff0000><blink>Loading......</blink></font>", true);
