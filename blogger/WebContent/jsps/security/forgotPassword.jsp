...
<layout:form action="/forgotPassword" styleClass="FORM" key="form.password.forgot.title" reqCode="button.search" focus="email">
	...
	<layout:text key="field.register.phone.home" hint="hint.register.phone.home" tooltip="hint.register.phone.home"
		property="phoneHome" cols="20" maxlength="20" isRequired="false" />
