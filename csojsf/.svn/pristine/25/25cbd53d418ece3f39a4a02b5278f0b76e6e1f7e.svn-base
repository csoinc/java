package test.cso.jsf2spring3.mybatis;
...
import com.cso.jsf2spring3.mybatis.SessionFactory;
import com.cso.jsf2spring3.mybatis.data.EmployeeDao;
import com.cso.jsf2spring3.mybatis.data.EmployeeMapper;
...
public class MybatisTest extends TestCase {
    ...
    public void ntestXMLConfig() {
        ...
        com.cso.jsf2spring3.mybatis.data.EmployeeMapper mapper = session.getMapper(com.cso.jsf2spring3.mybatis.data.EmployeeMapper.class);
        Employee emp = mapper.selectEmployee(1);
        log.debug("Firstname: " + emp.getFirstname());
        log.debug(" Lastname: " + emp.getLastname());
    }
