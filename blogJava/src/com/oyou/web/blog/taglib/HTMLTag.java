...
public final class HTMLTag extends BlogTagSupport {
			...
			if (map != null) {
				...
				if (StringHelper.isNotEmpty(id)) {
					try {
						...
						uploadFile.append(UploadHelper.getInstance().getUploadRelativePath(BlogMessageType.HTML, blogMessage.getUpdateTime()));
