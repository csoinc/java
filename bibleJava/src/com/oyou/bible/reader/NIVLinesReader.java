...
public class NIVLinesReader extends ISO88591Reader implements LineReader {

	public NIVLinesReader() {
		super();
		this.setFilename(BibleConstants.getInstance().getProperty(BibleConstants.NIV_TEXT_FILE));
		this.setBufferedReader();
		this.readLine(); // for this reader need get off the first  
	}

	public NIVLinesReader(String filename) {
		super(filename);
		this.readLine(); // for this reader need get off the first
	}
