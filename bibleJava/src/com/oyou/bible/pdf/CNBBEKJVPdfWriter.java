...
public class CNBBEKJVPdfWriter extends CNPdfWriter {
	protected static final Log log = LogFactory.getLog(CNBBEKJVPdfWriter.class);
	...
	public CNBBEKJVPdfWriter() {
		super();
		this.loadAllData();
	}

	public CNBBEKJVPdfWriter(String cover, String footer) {
		super(cover, footer);
		this.loadAllData();
	}

	public CNBBEKJVPdfWriter(String filename, String author, String cover, String footer) {
